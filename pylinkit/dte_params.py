...
class DTEParamMap():
    ...
    [ "CAM_SENSOR_ENABLE", "CAM01", BOOLEAN ],
    [ "CAM_TRIGGER_ON_SURFACED", "CAM02", BOOLEAN ],
    [ "CAM_TRIGGER_ON_AXL_WAKEUP", "CAM03", BOOLEAN ],
    [ "CAM_PERIOD_ON", "CAM04", UINT ],
    [ "CAM_PERIOD_OFF", "CAM05", UINT ],
